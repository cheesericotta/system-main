...
<title>Add Seminar | Al-Ikwaniah Mosque Activity System</title>
	 ...
	 <%@ include file = "AdminMenu.jsp" %>
		...
		<main>
			<div class="py-5 text-center">
				<img class="d-block mx-auto mb-4" src="assets/brand/mosque.svg" alt="" width="102" height="97">
				<h2>Seminar</h2>
				<p class="lead">Please add the seminar information in the right table</p>
			</div>
				...
				<div class="col-md-7 col-lg-8">
					...
					<form action="AddSeminar" method="POST" >
						<div class="row g-3">
								...
								<input type="text" class="form-control" name="ActivityID" value="AS" required>
								...
								<input type="text" class="form-control" name="ActivityTitle" value="AS" required>
								...
								<input type="text" class="form-control" name="InstructorName" required>
								...
								<input type="number" class="form-control" name="SeminarFee" required>
								<div class="invalid-feedback">Valid activity name is required.</div>
								</div>
