...
<title>View Charity | Al-Ikwaniah Mosque Activity System</title>
    ...
    <article class="my-3" id="tables">
      <div class="bd-example">
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              <th scope="row"><c:out value="${charity.activityID}" /><br></th>
              <td><c:out value="${charity.donationType}" /><br></td>
              <td><c:out value="${charity.activityType}" /><br></td>
              <td><c:out value="${charity.activityStartTime}" /><br></td>
              <td><c:out value="${charity.activityEndTime}" /><br></td>
              <td><c:out value="${charity.adminID}" /><br></td>
            </tr>
          </tbody>
        </table>
      </div>
