...
<div class="box">
        <div class="row g-5">
          ...
          <div class="col-md-7 col-lg-8">
            <h4 class="mb-3"><c:out value="${lecture.activityTitle}" /></h4>
            <form class="needs-validation" novalidate>
              <div class="row g-3">
  				
             
                <div class="col-sm-6">
                  <label for="Time" class="form-label">Start Time:  <c:out value="${lecture.activityStartTime}" /></label>
                </div>
                <div class="col-sm-6">
                  <label for="Time" class="form-label">End Time:  <c:out value="${lecture.activityEndTime}" /></label>
                </div>

                <div class="col-sm-6">
                </div>
                <div class="col-12">
                  <label for="username" class="form-label">Lecture Slot:<c:out value="${lecture.lectureSlot}" /></label>
                </div>
                <div class="col-12">
