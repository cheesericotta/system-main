...
public class LectureDAO extends ActivityDAO {
	static Connection con = null;
	static ResultSet rs = null;
	static PreparedStatement ps = null;
	static Statement stmt = null;

	private String LectureSlot,UstazName;
	...
	public static Lecture getLecture(String ActivityID) {
	...
	public void updateLecture(Lecture bean) {
		...
		try {
			...
			String sql = "UPDATE lecture SET  UstazID=?,LectureSlot=?, WHERE ActivityID=?";
